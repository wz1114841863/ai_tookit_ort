...
class AgeGoogleNet(BasicOrtHandler):
    """ https://github.com/onnx/models/tree/main/validated/vision/body_analysis/age_gender/models """

    def __init__(self, onnx_path: str, num_threads: int = 1):
        super(AgeGoogleNet, self).__init__(onnx_path, num_threads)
    ...
    def detect(self, mat: np.ndarray):
        ...
        pred_age = (self.age_intervals[max_id]
                    [0] + self.age_intervals[max_id][1]) / 2.0
